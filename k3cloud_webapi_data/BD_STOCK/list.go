...
func ListBDSTOCK(sdk *k3cloud_webapi.K3CloudApiSdk) {
	//fmt.Println("hello")
	getAllListBDSTOCK(sdk)
}
...
// 单据查询接口
func getAllListBDSTOCK(sdk *k3cloud_webapi.K3CloudApiSdk) {
