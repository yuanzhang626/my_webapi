...
func ListBDSupplier(sdk *k3cloud_webapi.K3CloudApiSdk) {
	//fmt.Println("hello")
	getAllListBDSupplier(sdk)
}
...
// 单据查询接口
func getAllListBDSupplier(sdk *k3cloud_webapi.K3CloudApiSdk) {
