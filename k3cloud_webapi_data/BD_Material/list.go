...
var (
	...
	fCategoryID  = "198163" //物料分组，198163 3.01(促销品)
...
func ListBDMaterial(sdk *k3cloud_webapi.K3CloudApiSdk) {
	//fmt.Println("hello")
	getAllListBDMaterial(sdk)
}
...
// 单据查询接口
func getAllListBDMaterial(sdk *k3cloud_webapi.K3CloudApiSdk) {
